    ...
    <Section title="Details">
      <Stack gap="xs">
        ...
        >
          ...
          <Text fz="xs" c="dimmed">
            Per-upstream overrides. Blank = defaults (base call 150s, hard
            ceiling 300s, tools/list 60s, response cap 256&nbsp;KB). A long call
            blocks this MCP session serially — every other tool queues behind
            it, so raise the call timeouts only where genuinely needed.
          </Text>
          <Group gap="xs" grow>
            <NumberInput
