...
CREATE TABLE users (
  ...
  name         TEXT,
  avatar_url   TEXT,
  idp          TEXT NOT NULL CHECK (idp IN ('google', 'github')),
...
CREATE TABLE upstream_servers (
  ...
  transport     TEXT NOT NULL CHECK (transport IN ('streamable_http', 'sse', 'stdio_daytona')),
  url           TEXT,
...
CREATE TABLE sandbox_sessions (
  ...
  state          TEXT NOT NULL CHECK (state IN ('starting', 'running', 'idle', 'archived', 'destroyed')),
